...
import { preStyle, privacyPageStyle } from './style';

export function Privacy() {
  return (
    <>
      <AppLayout title='개인정보처리방침'>
        <div id='privacy-page' css={privacyPageStyle}>
          <Heading2>개인정보처리방침</Heading2>
          <pre css={preStyle}>
            (주)센슈얼링 고객님의 개인정보를 중요시하며, &quot;정보통신망 이용촉진 및 정보보호&quot;에 관한 법률을 준수하고 있습니다.<br />
            ...
            o 위탁업무 내용 : [위탁업무 내용]<br /><br />

            ■ 이용자 및 법정대리인의 권리와 그 행사방법<br /><br />
            o 이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나 수정할 수 있으며 가입해지를 요청할 수도 있습니다.<br /><br />
